...
//         check that value of second button is "This is also a button"
        ...
        assertEquals("This is also a button", "This is also a 7 button", driver.findElement(By.id("buttonId")).getAttribute("value"));
    }

    @Test
    public void assertTrueTask() throws Exception {
        assertTrue(driver.findElement(By.id("buttonId")).getAttribute("value").equalsIgnoreCase("this is Also a Button"));
//         TODO:
