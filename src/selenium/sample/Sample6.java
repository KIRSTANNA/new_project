...
//        find element by id using CSS
        ...
        System.out.println("\t text of element with id 'heading_1' is '" + driver.findElement(By.cssSelector("#heading_1")).getText() + "'");
        System.out.println("\t text of element with id 'standartText' is '" + driver.findElement(By.cssSelector("#standartText")).getText() + "'");
        System.out.println("\t text of element with id 'nonStandartText' is '" + driver.findElement(By.cssSelector("#nonStandartText")).getText() + "'");
    }
...
//        find element by all classes using xPath
        ...
        System.out.println("\t text of element with class 'text' and 'unbelievable' is '" + driver.findElement(By.xpath("//*[contains(@class='text unbelievable')]")).getText() + "'");
...
//        find element by 1 of nth class using CSS
        ...
        System.out.println("\t text of element with class 'unbelievable' is '" + driver.findElement(By.xpath("//*[contains(@class, 'unbelievable')]")).getText() + "'");

//        find element by 1 of nth class using CSS
        System.out.println("Find element by 1 of nth class using CSS:");
        System.out.println("\t text of element with class 'unbelievable' is '" + driver.findElement(By.cssSelector(".unbelievable")).getText() + "'");
    }
...
//        find nth element using xPath
        ...
        System.out.println("\t text of 1-st element with tag name 'p' is '" + driver.findElement(By.xpath("//p[1]")).getText() + "'");
        System.out.println("\t text of 3-rd element with tag name 'p' is '" + driver.findElement(By.xpath("//p[3]")).getText() + "'");

//        find nth element using CSS
        System.out.println("Find element nth using CSS:");
        System.out.println("\t text of 1-st element with tag name 'p' is '" + driver.findElement(By.cssSelector("p:nth-of-type(1)")).getText() + "'");
        System.out.println("\t text of 3-rd element with tag name 'p' is '" + driver.findElement(By.cssSelector("p:nth-of-type(3)")).getText() + "'");
    }
...
//        find element by other attributes using xPath (e.g. name)
        ...
        System.out.println("\t value of element with name 'randomButton1' is '" + driver.findElement(By.xpath("//*[@name='randomButton1']")).getAttribute("value") + "'");
        System.out.println("\t name of element with value 'This is a button' is '" + driver.findElement(By.xpath("//*[@value='This is a button']")).getAttribute("name") + "'");
        System.out.println("\t value of element with type 'button' is '" + driver.findElement(By.xpath("//*[@type='button']")).getAttribute("value") + "'");

//        find child element using CSS
        System.out.println("Find element by other attributes using CSS:");
        System.out.println("\t value of element with name 'randomButton1' is '" + driver.findElement(By.cssSelector("[name='randomButton1']")).getAttribute("value") + "'");
        System.out.println("\t name of element with value 'This is a button' is '" + driver.findElement(By.cssSelector("[value='This is also a button']")).getAttribute("name") + "'");
        System.out.println("\t value of element with type 'button' is '" + driver.findElement(By.cssSelector("[type='button']")).getAttribute("value") + "'");
    }
